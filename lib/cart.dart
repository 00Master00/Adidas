...
class AdidasScreen extends StatelessWidget {
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            ClipRRect(
              child: Image.asset(
                'assets/images/promotions.jpg', // Path should be correct and match pubspec.yaml
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ListTile(
                    leading: Image.asset('assets/icon/shoes.png',
                        width: 24, height: 24),
                    title: Text("SHOES",
                        style: TextStyle(
                  ...
                  ListTile(
                    leading: Image.asset('assets/icon/polo-shirt.png',
                        width: 24, height: 24),
                    title: Text("CLOTHING",
                        style: TextStyle(
                            fontSize: 16, fontWeight: FontWeight.bold)),
                  ...
                  ListTile(
                    leading: Image.asset('assets/icon/hat.png',
                        width: 24, height: 24),
  ...
  Widget _buildCategoryItem(IconData icon, String label) {
    return Container(
      ...
      padding:
          EdgeInsets.symmetric(vertical: 10, horizontal: 8), // ✅ ปรับ Padding
      child: Column(
